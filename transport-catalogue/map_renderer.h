...
public:
    ...
    void  PrepareTextStop(svg::Text &temp, bool zaliv,const std::string& busName,const std::string& color,const MapSetting& tempSetting,const Stop stop,const Plane::SphereProjector &proj);
